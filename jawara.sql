...
--
-- Host: localhost:3306
-- Generation Time: Dec 05, 2025 at 05:25 AM
...
--
-- Table structure for table `iuran_bills`
--

CREATE TABLE `iuran_bills` (
  `id` int NOT NULL,
  `family_id` int NOT NULL,
  `iuran_type_id` int DEFAULT NULL,
  `amount` decimal(18,2) NOT NULL,
...
(1, 'Admin Sistem', 'admin@jawara.com', '$2b$12$aGmMiVFuO7Mo1pTJKXbu4OsSY2GzU7k9ABgWUkTjNfXQLLHEq6Lwe', '1111111111111111', '0811111111', 'Jl. Mawar No. 1', 1, 'active', '2025-11-24 11:54:33', '2025-11-24 11:54:33'),
(2, 'Ketua RT', 'rt@jawara.com', '$2b$12$aGmMiVFuO7Mo1pTJKXbu4OsSY2GzU7k9ABgWUkTjNfXQLLHEq6Lwe', '2222222222222222', '0822222222', 'Jl. Melati No. 10', 2, 'active', '2025-11-24 11:54:33', '2025-11-24 11:54:33'),
(3, 'Ketua RW', 'rw@jawara.com', '$2b$12$aGmMiVFuO7Mo1pTJKXbu4OsSY2GzU7k9ABgWUkTjNfXQLLHEq6Lwe', '3333333333333333', '0833333333', 'Jl. Anggrek No. 20', 3, 'active', '2025-11-24 11:54:33', '2025-11-24 11:54:33'),
(4, 'Bendahara', 'bendahara@jawara.com', '$2b$12$aGmMiVFuO7Mo1pTJKXbu4OsSY2GzU7k9ABgWUkTjNfXQLLHEq6Lwe', '4444444444444444', '0844444444', 'Jl. Kenanga No. 17', 4, 'active', '2025-11-24 11:54:33', '2025-11-24 11:54:33'),
(5, 'Warga Satu', 'warga1@jawara.com', '$2b$12$aGmMiVFuO7Mo1pTJKXbu4OsSY2GzU7k9ABgWUkTjNfXQLLHEq6Lwe', '5555555555555555', '0855555555', 'Jl. Kemuning No. 5', 5, 'active', '2025-11-24 11:54:33', '2025-11-24 11:54:33');
...
--
-- Indexes for table `iuran_bills`
--
ALTER TABLE `iuran_bills`
  ADD PRIMARY KEY (`id`),
  ADD KEY `iuran_type_id` (`iuran_type_id`),
  ADD KEY `ix_iuran_bills_id` (`id`);
...
--
-- AUTO_INCREMENT for table `iuran_bills`
--
ALTER TABLE `iuran_bills`
...
--
-- Constraints for table `iuran_bills`
--
ALTER TABLE `iuran_bills`
  ADD CONSTRAINT `iuran_bills_ibfk_1` FOREIGN KEY (`iuran_type_id`) REFERENCES `iuran_types` (`id`);
